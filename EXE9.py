...
PLACEHOLDER_EXE_TEXT  = "Drag & drop a .exe here or click Browse"
...
FOOTER_MESSAGE = "Output will be in the script's 'dist' folder. - EXE9 v1.2.3"
SIGNATURE = "Build and Design by Milo Pesqueira - exe9.org"
...
class CompilerApp:
    ...
    def create_widgets(self):
        ...
        compile_btn = tk.Button(
            self.tab_compiler,
            text="Compile" if platform.system() == "Windows" else ("Generate .app" if platform.system() == "Darwin" else "Generate Binary"),
